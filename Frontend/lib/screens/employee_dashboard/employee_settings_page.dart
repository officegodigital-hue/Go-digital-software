// lib/screens/employee_dashboard/employee_settings_page.dart
import 'dart:convert';
...
class EmployeeSettingsPage extends StatefulWidget {
  ...
  @override State<EmployeeSettingsPage> createState() => _EmployeeSettingsPageState();
}
...
class _EmployeeSettingsPageState extends State<EmployeeSettingsPage> {
    ...
    showDialog(context: context, builder: (dc) => StatefulBuilder(
      builder: (context, setStateDialog) {
        return AlertDialog(
          ...
          title: Row(children:[
            _iconBox(Icons.lock_reset_rounded, AppColors.primary),
              ...
              children: [
                TextField(
                  ...
                  decoration: _input('Current Password', Icons.lock_outline_rounded).copyWith(
                    suffixIcon: IconButton(
                      icon: Icon(obscureCur ? Icons.visibility_off_outlined : Icons.visibility_outlined, size: 19, color: AppColors.textGrey),
                ...
                TextField(
                  ...
                  decoration: _input('New Password', Icons.password_rounded).copyWith(
                    suffixIcon: IconButton(
                      icon: Icon(obscureNeu ? Icons.visibility_off_outlined : Icons.visibility_outlined, size: 19, color: AppColors.textGrey),
                ...
                TextField(
                  ...
                  decoration: _input('Confirm New Password', Icons.verified_user_outlined).copyWith(
                    suffixIcon: IconButton(
                      icon: Icon(obscureCon ? Icons.visibility_off_outlined : Icons.visibility_outlined, size: 19, color: AppColors.textGrey),
  ...
  InputDecoration _input(String hint, IconData icon) => InputDecoration(
    ...
    prefixIcon: Icon(icon, size: 19, color: const Color(0xFF8995AA)), filled: true,
  ...
  static Widget _iconBox(IconData i, Color c) => Container(
    width: 42, height: 42,
            ...
            child: ConstrainedBox(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _section(Icons.person_outline_rounded, AppColors.primary, 'Personal Information',
                    'Update the name displayed across your GoDigital account.', _personal(mobile)),
                  const SizedBox(height: 18),
                  _section(Icons.manage_accounts_outlined, const Color(0xFF7C3AED),
                    'Account Information', 'Manage your username and email address.', _account(mobile)),
                  const SizedBox(height: 18),
                  _section(Icons.badge_outlined, const Color(0xFF0891B2),
                    'Work Information', 'These details are controlled by the main admin.', _work(mobile)),
                  const SizedBox(height: 18), _security(mobile),
                  const SizedBox(height: 24), _actions(mobile),
                  const SizedBox(height: 18),
                  const Center(child: Text('GoDigital • Employee Settings', style: TextStyle(fontSize: 11, color: AppColors.textGrey))),
                ],
              ),
            ),
          ),
  ...
  Widget _header(bool m) => Container(
    ...
    decoration: BoxDecoration(
      gradient: const LinearGradient(colors: [Color(0xFF063B98), AppColors.primary]),
      borderRadius: BorderRadius.circular(22),
      boxShadow: [BoxShadow(color: AppColors.primary.withValues(alpha: 0.18), blurRadius: 24, offset: const Offset(0, 10))],
    ),
    child: Row(
      children: [
        Container(
          width: m ? 46 : 54, height: m ? 46 : 54,
          decoration: BoxDecoration(
        ...
        Expanded(
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: const [
              Text('Employee Settings', style: TextStyle(color: Colors.white, fontSize: 30, fontWeight: FontWeight.w900)),
              SizedBox(height: 4),
              Text('Manage your profile and account preferences.', style: TextStyle(color: Colors.white70, fontSize: 13, fontWeight: FontWeight.w500)),
            ],
          ),
        ),
      ],
    ...
    final content = Column(
      ...
      children: [
        Text(name.isEmpty ? 'Your Profile' : name, textAlign: m ? TextAlign.center : TextAlign.left,
          style: TextStyle(fontSize: m ? 20 : 22, fontWeight: FontWeight.w900, color: AppColors.textDark)),
        ...
        Text(_emailController.text.trim().isEmpty ? 'Add your email address' : _emailController.text.trim(),
          ...
          style: const TextStyle(fontSize: 12.5, color: AppColors.textGrey, fontWeight: FontWeight.w500)),
        if (_role.isNotEmpty) Padding(
          padding: const EdgeInsets.only(top: 9),
          child: Container(
            padding: const EdgeInsets.symmetric(horizontal: 11, vertical: 6),
            decoration: BoxDecoration(color: const Color(0xFFEAF2FF), borderRadius: BorderRadius.circular(30)),
            child: Text(_role, style: const TextStyle(color: AppColors.primary, fontSize: 11, fontWeight: FontWeight.w800)),
          ),
        ),
      ],
    );
  ...
  Widget _avatar(ImageProvider? p, String initials, double r) => Stack(
    ...
    children: [
      Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(color: _color(_avatarColorHex).withValues(alpha: 0.28), width: 2),
        ),
        child: CircleAvatar(
          radius: r, backgroundColor: _color(_avatarColorHex), backgroundImage: p,
          child: p == null ? Text(initials.isEmpty ? '?' : initials,
            style: TextStyle(color: Colors.white, fontSize: r * 0.58, fontWeight: FontWeight.w900)) : null,
        ),
      ),
      Positioned(
        right: -2, bottom: 3,
  ...
  Widget _photoButtons() => Wrap(
    alignment: WrapAlignment.end, spacing: 8,
    children: [
      OutlinedButton.icon(
        ...
        style: OutlinedButton.styleFrom(
          foregroundColor: AppColors.primary, side: const BorderSide(color: Color(0xFFCAD8F0)),
          padding: const EdgeInsets.symmetric(horizontal: 14, vertical: 12),
          shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12)),
        ),
      ),
      if (_profilePhotoDataUrl != null) TextButton.icon(
  ...
  Widget _colors() => Container(
    padding: const EdgeInsets.symmetric(horizontal: 13, vertical: 10),
    decoration: BoxDecoration(color: const Color(0xFFF8FAFD), borderRadius: BorderRadius.circular(14), border: Border.all(color: AppColors.border)),
    child: Wrap(
      alignment: WrapAlignment.end, crossAxisAlignment: WrapCrossAlignment.center,
      spacing: 8, runSpacing: 7,
      children: [
        const Text('Initials color', style: TextStyle(fontSize: 11, color: AppColors.textGrey, fontWeight: FontWeight.w700)),
        ..._avatarColorOptions.map((h) {
          ...
          return GestureDetector(
            ...
            child: AnimatedContainer(
              ...
              decoration: BoxDecoration(
                color: _color(h), shape: BoxShape.circle,
                border: Border.all(color: Colors.white, width: 2),
                boxShadow: [BoxShadow(color: _color(h).withValues(alpha: 0.25), blurRadius: 5)],
              ),
  ...
  Widget _section(IconData i, Color c, String title, String sub, Widget child) => Container(
    ...
    decoration: BoxDecoration(
      ...
      border: Border.all(color: AppColors.border),
      boxShadow: [BoxShadow(color: Colors.black.withValues(alpha: 0.025), blurRadius: 15, offset: const Offset(0, 6))],
    ),
    child: Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Row(
          children: [
            _iconBox(i, c), const SizedBox(width: 12),
            Expanded(
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  ...
                  Text(sub, style: const TextStyle(color: AppColors.textGrey, fontSize: 11.5)),
                ],
              ),
            ),
          ],
  ...
  Widget _personal(bool m) => Column(
    children: [
      ...
      SizedBox(height: m ? 14 : 16),
      _field('Last Name', _lastNameController, Icons.person_outline_rounded),
    ],
  );
  ...
  Widget _work(bool m) => _row(m,
    _locked('Employee ID', _staffId.isEmpty ? '—' : _staffId),
  ...
  Widget _field(String label, TextEditingController c, IconData i, [bool required = true]) => Column(
    ...
    children: [
      Row(children: [
        Text(label, style: const TextStyle(fontSize: 12.5, fontWeight: FontWeight.w800, color: AppColors.textDark)),
      ...
      TextField(
        ...
        cursorColor: AppColors.primary, decoration: _input('Enter $label', i),
      ),
    ],
  );

  Widget _locked(String label, String value) => Column(
    crossAxisAlignment: CrossAxisAlignment.start,
    children: [
      Row(children: [
        Text(label, style: const TextStyle(fontSize: 12.5, fontWeight: FontWeight.w800, color: AppColors.textDark)),
      ...
      Container(
        ...
        decoration: BoxDecoration(color: const Color(0xFFF2F5F9), borderRadius: BorderRadius.circular(13), border: Border.all(color: AppColors.border)),
        child: Row(
          children: [
            Icon(label == 'Role' ? Icons.work_outline_rounded : Icons.badge_outlined, size: 18, color: const Color(0xFF8995AA)),
            const SizedBox(width: 10),
            Expanded(child: Text(value, overflow: TextOverflow.ellipsis, style: const TextStyle(fontSize: 13.5, color: AppColors.textGrey, fontWeight: FontWeight.w700))),
  ...
  Widget _security(bool m) => Container(
    width: double.infinity, padding: const EdgeInsets.all(22),
    decoration: BoxDecoration(color: Colors.white, borderRadius: BorderRadius.circular(20), border: Border.all(color: AppColors.border)),
    child: m ? Column(
      children: [
        Row(children: [
          _iconBox(Icons.shield_outlined, const Color(0xFFD97706)), const SizedBox(width: 13),
          const Expanded(child: Text('Password & Security', style: TextStyle(color: AppColors.textDark, fontSize: 15, fontWeight: FontWeight.w900))),
        ]),
        const SizedBox(height: 10),
        const Text('Keep your account secure with a strong password.', style: TextStyle(color: AppColors.textGrey, fontSize: 11.5)),
        const SizedBox(height: 13),
        SizedBox(
          width: double.infinity,
          child: OutlinedButton(
            onPressed: _changePassword,
            style: OutlinedButton.styleFrom(foregroundColor: AppColors.primary, side: const BorderSide(color: Color(0xFFCAD8F0)),
              shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12))),
            child: const Text('Change Password'),
          ),
        ),
      ...
      children: [
        ...
        const Expanded(
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Text('Password & Security', style: TextStyle(color: AppColors.textDark, fontSize: 15, fontWeight: FontWeight.w900)),
              SizedBox(height: 3),
              Text('Keep your account secure with a strong password.', style: TextStyle(color: AppColors.textGrey, fontSize: 11.5)),
            ],
          ),
        ),
        OutlinedButton(
  ...
  Widget _actions(bool m) => m ? Column(
    crossAxisAlignment: CrossAxisAlignment.stretch,
    children: [_save(), const SizedBox(height: 10), _cancel()],
  ) : Row(
    mainAxisAlignment: MainAxisAlignment.end,
    children: [_cancel(), const SizedBox(width: 12), _save()],
  );

  Widget _save() => ElevatedButton.icon(
  ...
  Widget _cancel() => OutlinedButton(
    ...
    style: OutlinedButton.styleFrom(
      foregroundColor: AppColors.textDark, backgroundColor: Colors.white,
      side: const BorderSide(color: AppColors.border), shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(13)),
      padding: const EdgeInsets.symmetric(horizontal: 24, vertical: 15),
    ),
