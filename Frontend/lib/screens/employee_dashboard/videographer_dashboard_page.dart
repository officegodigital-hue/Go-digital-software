...
changes = productivity['changes'] ?? 0;
          tasks = rawTasks.map((t) => VideographerTaskModel(
            ...
            shootingDate:    _formatDate(t['submissionDate'] as String?),
  ...
  Future<void> updateTask(VideographerTaskModel task, String endpointAction, String localAction, String localStatus) async {
    ...
    return Container(
      ...
      child: const Row(
        children: [
          ...
          Expanded(
            flex: 2,
            child: Text('SHOOTING DATES', style: AppTextStyles.tableHeader),
          ),
          Expanded(
            flex: 2,
  ...
  Widget _taskRow(VideographerTaskModel task) {
    return Container(
      height: 52,
      padding: const EdgeInsets.symmetric(horizontal: 24),
      decoration: const BoxDecoration(
      ...
      child: Row(
        children: [
          ...
          Expanded(
            flex: 2,
            child: Text(task.shootingDate, style: AppTextStyles.tableText),
          ),
          Expanded(
            flex: 2,
            child: Align(
