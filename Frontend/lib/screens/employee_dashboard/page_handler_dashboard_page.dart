// name=page_handler_dashboard_page.dart
import 'dart:convert';
...
class PageHandlerDashboardPage extends StatefulWidget {
  ...
  const PageHandlerDashboardPage({
    super.key,
...
class _PageHandlerDashboardPageState extends State<PageHandlerDashboardPage> {
  ...
  // 🟢 4 Cards setup (Assigned Clients, New Clients, Hold Task, Inactive Today)
  ...
  Widget _mobileTaskCard(PageHandlerTaskModel task) {
    return Container(
      width: double.infinity,
  ...
  Widget _premiumTaskRow(PageHandlerTaskModel task, int index) {
...
class _PremiumTaskRow extends StatefulWidget {
  final PageHandlerTaskModel task;
  final int index;
...
class _PremiumTaskRowState extends State<_PremiumTaskRow> {
  ...
  PageHandlerTaskModel get task => widget.task;
  ...
  Widget _dueDateWidget(PageHandlerTaskModel task) {
