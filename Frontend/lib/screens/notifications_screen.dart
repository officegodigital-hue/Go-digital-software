...
import '../../layouts/admin_layout.dart'; // 🟢 Correct relative path to AdminLayout
...
final String sizeText = sizeInKb > 1024 
  ...
  Widget build(BuildContext context) {
    ...
    // 🟢 Wrapped inside AdminLayout using Expanded container to prevent vertical unbounded viewport errors
    return AdminLayout(
