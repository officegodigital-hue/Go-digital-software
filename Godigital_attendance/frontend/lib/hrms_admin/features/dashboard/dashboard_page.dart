        ...
        for (final employee in employees)
          AttendanceRowData(
            ...
            totalSalaryAfterLeaves:
                '${employee.deductionDays} · −${employee.leaveDeduction}',
...
class _EmployeeAttendance {
  ...
  factory _EmployeeAttendance.fromApi(Map<String, dynamic> json) {
    ...
    return _EmployeeAttendance(
      ...
      deductionDays: (json['deductionDays'] ?? '0').toString(),
      leaveDeduction: (json['leaveDeduction'] ?? '–').toString(),
